...
# class SHRED_SINDy(torch.nn.Module):
#     '''SHRED model accepts input size (number of sensors), output size (dimension of high-dimensional spatio-temporal state, hidden_size, number of LSTM layers,
#     size of fully-connected layers, and dropout parameter'''
#     def __init__(self, input_size, output_size, hidden_size=64, hidden_layers=1, l1=350, l2=400, dropout=0.0):
#         super(SHRED,self).__init__()
...
#         self.sindy_coefficients = torch.ones(library_dim, latent_dim, requires_grad=True)
#         torch.nn.init.normal_(self.sindy_coefficients, mean=0.0, std=0.0)
